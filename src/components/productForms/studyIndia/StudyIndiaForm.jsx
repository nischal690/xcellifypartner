...
const StudyIndiaForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    hsn_code: hsnCodeMapping['Study India'],
    gst_rate: gstRateMapping['Study India'],
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await appStore.submitProducts('Study India', payload);

    if (result.success) {
      toast.success('Study India Product submitted successfully!');
      navigate('/home/products');
    } else {
      toast.error('Failed to submit Study India Product');
