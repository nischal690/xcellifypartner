...
export default function EmailVerificationPwd({closeDialog}) {
    ...
    let handleSubmit = async ()=>{
        ...
        if(response?.status === HTTP_CODE.SUCCESS){
            ...
            toast.error("An error occured, Please try again", { position: 'top-right' });
        }
    }
  ...
  return (
        ...
        <div className="flex flex-col p-5 bg-white rounded-lg shadow-md dark:border max-w-xl w-full sm:p-20">
            ...
            <p className='text-[#848484] text-base p-1'>Enter your email to receive a password reset link</p>
            ...
            <div className='flex justify-center mt-4'>
                ...
                <p onClick={closeDialog} className='items-center text-purple-primary cursor-pointer'>Login</p>
            </div>
