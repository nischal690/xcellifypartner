...
const Dashboard = () => {
  ...
  const quickActions = [
    { name: "Add New Product", icon: "📦", action: () => navigate("/addNewProduct") },
    { name: "View Analytics", icon: "📊", action: () => navigate("/home/dashboard") },
    { name: "Update Profile", icon: "👤", action: () => navigate("/home/profile") },
    { name: "Support", icon: "🛟", action: () => window.open("/contact", "_blank") },
  ];
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold">
                    {greeting}, {appStore.partnerInfo?.name || "Vendor"}! 👋
                  </h1>
                ...
                <div className="mt-6 md:mt-0">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 inline-block">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-blue-100">{new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white shadow-sm rounded-xl p-6 border-l-4 border-blue-500 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mt-1">{totalOrdersCount}</h2>
                </div>
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-500">
                  {totalOrdersCount > 0 ? `${totalOrdersCount} orders in selected period` : "No orders yet"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded-xl p-6 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mt-1">
                    ₹{totalOrdersCount > 0 
                      ? (totalRevenue / totalOrdersCount).toFixed(2).toLocaleString('en-IN') 
                      : 0}
                  </h2>
                </div>
              ...
              <div className="mt-4">
                <p className="text-sm text-purple-500">
                  {totalOrdersCount > 0 ? "Based on completed orders" : "No orders yet"}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-sm rounded-xl p-6 border-l-4 border-yellow-500 hover:shadow-md transition-shadow">
              ...
              <div className="mt-4">
                <p className="text-sm text-yellow-600">
                  {totalOrdersCount > 0 ? "Up 0.5% from last period" : "No data available"}
                </p>
              </div>
            </div>
          </section>
