...
export default function TutoringEdit({ product_id }) {
    ...
    const getProducts = async () => {
      ...
      if (fetchedProductInfo && fetchedProductInfo.data) {
        ...
        setFormData({
          ...
          member_since: product.member_since || '',
          service_provided_since: product.service_provided_since || '',
          mode_of_teaching: product.mode_of_teaching || '',
          ...
          travel_upto: product.travel_upto || null,
      ...
      <form className="max-w-5xl mx-auto p-6 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onChange={(options) =>
                  handleMultiSelectChange('subjects', options)
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              >
                <option>Select Member since</option>
                {Array.from(
                  {
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block font-medium mb-1">
                Can travel up to in km*(N/A for online & home visits)
                <span className="text-red-500">*</span>
              </label>
              <select
                className="w-full border rounded-lg px-3 py-2"
                value={formData.travel_upto || ''}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    travel_upto: e.target.value,
                  })
                }
              >
                <option disabled>Select travel up to in km</option>
