...
export default function EventsEdit({ product_id }) {
    ...
    const getProducts = async () => {
      ...
      if (fetchedProductInfo && fetchedProductInfo.data) {
        ...
        setFormData({
          ...
          event_delivery: product.event_delivery || '',
          event_registration_deadline:
            product.event_registration_deadline || '',
  ...
  const handleSubmit = async (e) => {
    ...
    const submitProduct = await apiRequest({
      url: `/mic-events/updateProduct/${product_id}`,
      method: 'POST',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onChange={(options) =>
                  handleMultiSelectChange('event_location', options)
                }
              />
            </div>
            <div>
            ...
            <div>
              <label className="block font-medium mb-1">Age Group Min</label>
              <input
                type="text"
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    age_group_min: e.target.value,
                  })
                }
              />
            </div>
            <div>
              <label className="block font-medium mb-1">Age Group Max</label>
              <input
                type="text"
                placeholder="Enter Education qualification"
                className="w-full border rounded-lg px-3 py-2"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    event_eligibility: e.target.value,
                  })
                }
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Select
                ...
                value={formData?.event_delivery
                  ?.split(', ')
                  ?.filter(Boolean)
                  ?.map((value) => ({ value, label: value }))}
                onChange={(options) =>
                  handleMultiSelectChange('event_delivery', options)
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    event_registration_deadline: e.target.value,
                  })
                }
              />
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                placeholder="Enter Event registration fees"
                className="w-full border rounded-lg px-3 py-2"
