...
let imagesWithTextsObjs = [
  {
    ...
    direction: 'ltr',
    content: [
      'Xcellify began as a humble yet powerful dream– to create a world where education, growth, and opportunities are accessible to all. This dream was built on the idea of democratising access to quality resources so that students from every corner of the country are empowered to thrive academically, professionally, and personally.',
      "Xcellify isn't just a platform—it's a trusted partner in every student's journey. By bridging the gap between resources, guidance, and opportunities, we're building a comprehensive ecosystem designed to meet the diverse needs of students.",
    ],
  },
  {
    ...
    direction: 'rtl',
    content: [
      'We believe every student has the potential to achieve extraordinary things.',
      "Our name, a blend of 'Excel' and 'Amplify,' reflects our commitment to helping students discover their true potential, learn with purpose, and excel in life with confidence.",
      "The 'X' in our logo symbolizes the limitless possibilities within each person—possibilities we strive to unlock through innovation, guidance, and community.",
    ],
  },
  {
    ...
    image: Image3,
    direction: 'ltr',
    subHeadings: ['Mission', 'Vision'],
    content: [
      'To be the preferred marketplace for students, meeting all their needs and enabling them to achieve their full potential by nurturing excellence.',
      'We strive to empower students through innovative platforms providing the best, curated resources in a convenient and cost-effective manner to help them excel in everything they do.',
    ],
  },
];
...
let magicObj = [
  {
    image: Mimg,
    content:
      "A one-stop destination for diverse, high-quality products and services tailored to every student's educational and lifestyle needs.",
  },
  {
    image: Aimg,
    content:
      'An inclusive platform that provides equal access to high-quality curated resources, fostering equity & empowerment in education.',
  },
  {
    image: Gimg,
    content:
      'We empower students to shape brighter futures through an educational transformation that transcends borders.',
  },
  {
    image: Iimg,
    content:
      'We constantly leverage AI, analytics, and cutting-edge technologies to adapt and deliver exceptional outcomes for students and educators alike.',
  },
  {
    image: Cimg,
    content:
      'We nurture a vibrant community where students can find guidance, collaboration, and support for academic, career, and personal growth.',
  },
];
        ...
        <div className="max-w-7xl mx-auto pt-8 px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="mt-6 text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
              Building a world where education, growth, and opportunities are
              accessible to all
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="block text-2xl md:text-3xl mt-3 text-gray-600 font-normal">
        ...
        >
          ...
          <WhyXcellify arrowImage={ThreeArraowsImg} peopleImage={PeopleBg} />
        </motion.div>
      </div>
      ...
      <footer className="bg-purple-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <img
                src={LogoPrimary}
                alt="Logo"
                className="w-32 bg-white p-2 rounded-lg mb-4"
              />
              <p className="text-sm">
                Empowering students to excel and amplify their potential through
                innovative platforms and resources.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-white border-opacity-20 text-center">
            <p className="text-sm">
              {' '}
              {new Date().getFullYear()} Xcellify. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
